...
但是使用cos learning rate scheduler再用only question prompt和reward function，不要求COT格式训练，模型训练有一个比较稳定的结果，最好在测试集上有45%的准确率。

![image-non-cot](assets/24.png)

![image-non-cot](assets/23.png)

![image-non-cot](assets/21.png)

![image-non-cot](assets/22.png)
